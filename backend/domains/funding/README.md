...
| USDT deposits / USDT treasury | `USDT_TRC20` adapter — declared, inactive until the treasury build (docs/governance/04-GOVERNANCE.md) |
...
- Existing implementation files stay in `domains/payment/` per the
  opportunistic-move rule (docs/governance/04-GOVERNANCE.md 2026-07-07); this module
