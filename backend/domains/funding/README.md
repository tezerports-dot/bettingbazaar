...
| USDT deposits / USDT treasury | `USDT_TRC20` adapter — declared, inactive until the treasury build (EXECUTION_QUEUE.md) |
...
- Existing implementation files stay in `domains/payment/` per the
  opportunistic-move rule (ENTERPRISE_DECISIONS.md 2026-07-07); this module
