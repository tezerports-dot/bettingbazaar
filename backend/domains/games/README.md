# domains/games/ — GAMES PLATFORM (BBEPS Phase 011 — DECLARED)
...
in-house game work (beyond the cycle market) lands HERE, gated by `FLAGS.GAMES_PLATFORM` (default false),
