# domains/event/ — EVENT PLATFORM (BBEPS Phase 011 — DECLARED)
...
event-feed work (fixtures, results, live data ingestion) lands HERE, gated by `FLAGS.EVENT_FEEDS` (default false),
