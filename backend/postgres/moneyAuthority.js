...
const CAPABILITIES = Object.freeze({
  ...
  [MONEY_PATHS.BETS]: {
    ...
    // legs exist. `implemented` waits on the same evidence the last two domains
    // waited on — the cross-store suite runs only in CI, because a MongoDB
    // replica set cannot run in the build sandbox. Flip when CI is green on it.
    implemented: false,
