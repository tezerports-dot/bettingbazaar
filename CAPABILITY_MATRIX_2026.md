...
| 17 | Point-in-Time Recovery | **PARTIAL** | `DISASTER_RECOVERY.md`, `PRODUCTION_READINESS.md` §A5; PG WAL / Atlas toggle | Enablement is an owner/provider action | Enable Atlas continuous backups / PG WAL archiving; test one restore | **High (owner)** |
