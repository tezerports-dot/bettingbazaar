...
# GOVERNANCE sec.15: every file must reference docs/governance/04-GOVERNANCE.md in first 10 lines.
# Run: bash scripts/add-governance-headers.sh

HEADER='// GOVERNANCE: Read docs/governance/04-GOVERNANCE.md before editing this file. (See sec.0 for mandatory pre-edit checklist.)'
ADDED=0
SKIPPED=0
