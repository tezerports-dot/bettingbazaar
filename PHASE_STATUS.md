...
| 010 — Risk Platform | **IN PROGRESS (2026-07-09)** | Renumbered by owner directive (old "Event Architecture" scope: eventBus now genuinely wired by Phase 009). Single authority for operational rules + all validation. |
