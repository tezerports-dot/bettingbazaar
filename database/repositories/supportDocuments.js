 ...
 * (database/pgClient.js), in its own `support_documents` table using the
 ...
 */
import { pgConfigured, pgQuery, getPool , connectGuarded } from '../client.js';
import { embeddingDim } from '../../backend/domains/support/embeddings.js';
